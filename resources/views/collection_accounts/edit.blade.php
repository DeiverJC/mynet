...
@section('title', 'Editar Collection Accounts')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('collectionAccounts.show', $collectionAccount->id) }}">
    ...
    <div class="col-md-6">
        <div class="white-box">
            ...
            <p class="text-muted m-b-30 font-13"> Lorem ipsum ... </p>
                {!! Form::model($collectionAccount, ['route' => ['collectionAccounts.update', $collectionAccount->id], 
