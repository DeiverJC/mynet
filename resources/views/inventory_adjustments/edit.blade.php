...
@section('title', 'Editar Inventory Adjustments')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('inventoryAdjustments.show', $inventoryAdjustment->id) }}">
    ...
    <div class="col-md-6">
        <div class="white-box">
            ...
            <p class="text-muted m-b-30 font-13"> Lorem ipsum ... </p>
                {!! Form::model($inventoryAdjustment, ['route' => ['inventoryAdjustments.update', $inventoryAdjustment->id], 
