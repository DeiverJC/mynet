...
<!-- Refence Code Field -->
<div class="form-group {{ $errors->has('refence_code') ? ' has-error' : '' }}">
    {!! Form::label('refence_code', 'Refence Code:', ['class' => 'control-label col-md-3']) !!}
    <div class="col-md-9">
        {!! Form::text('refence_code', null, [
            'class' => 'form-control', 
            'id' => 'refence_code', 
            'placeholder' => 'Refence Code'
        ]) !!}
        @if ($errors->has('refence_code'))
            <span class="help-block">{{ $errors->first('refence_code') }}</span> 
        @endif
    </div>
</div>
...
<div class="form-group {{ $errors->has('tax') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9">
        {!! Form::select('tax', ['0' => 'Ninguno - (0%)', '0' => 'IVA - (0%)', '5' => 'IVA - (5%)', '19' => 'IVA - (19%)'], null, ['class' => 'form-control', 'id' => 'tax']) !!}
        @if ($errors->has('tax'))
...
<div class="form-group {{ $errors->has('unit_measure') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9">
        {!! Form::select('unit_measure', ['' => 'Ninguno', 'M' => 'Metro', 'Kg' => 'Kilogramos'], null, ['class' => 'form-control', 'id' => 'unit_measure']) !!}
